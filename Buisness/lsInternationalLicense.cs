...
namespace Buisness
{
    public class lsInternationalLicense : clsApplication
    {
        ...
        public lsInternationalLicense(int ApplicationID, int ApplicantPersonID,
        ...
        public static lsInternationalLicense Find(int InternationalLicenseID)
        {
            int ApplicationID = -1;
            ...
            ref IssueDate, ref ExpirationDate, ref IsActive, ref CreatedByUserID))
            {
                ...
                return new lsInternationalLicense(Application.ApplicationID,
